...
public class DbMods {
    ...
    public static StringDataList findByName (DbConn dbc, String id) {
        
        StringDataList sdl = new StringDataList();
        try {
            String sql = "call get_recipe_record(?)";
            ...
            sd.errorMsg = "Exception thrown in Recipe.findByName(): " + e.getMessage();
            sdl.add(sd);
        }
        return sdl;
